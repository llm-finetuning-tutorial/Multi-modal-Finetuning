...
DEFAULT_CKPT_PATH = "/home/datadriven/ds.kang/Qwen-VL/output_qwen1"
...
def _get_args():
    ...
    parser.add_argument(
        "--server-port", type=int, default=22233, help="Demo server port."
    )
    parser.add_argument(
...
&nbsp<a href="https://github.com/QwenLM/Qwen-VL">Github</a></center>"""
        ...
        chatbot = gr.Chatbot(
            label="Qwen-VL-Chat", elem_classes="control-height", height=750
        )
